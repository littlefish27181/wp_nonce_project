...
use littlefish27181\WPNonce\WPNonceValidator;
use PHPUnit\Framework\TestCase;
/**
 * Tests for class Nonce_Validator.
 */
class WPNonceValidatorTest extends TestCase
{
	/**
	* Test action.
	*
	...
	* @var    object $test_validator The default test validator object.
	...
	protected function setUp() {
 		...
 		$this->test_validator1 = new WPNonceValidator( $this->test_action );
 		$this->test_validator2 = new WPNonceValidator( $this->test_action, $this->test_name );
    ...
    public function test_instance() {
		$this->assertInstanceOf( WPNonceValidator::class, $this->test_validator2 );
		$this->assertInstanceOf( WPNonceValidator::class, $this->test_validator1 );
	}
	/**
 	...
 	*/
 	public function test_default_name() {
 		$nv = new WPNonceValidator( 'another_action' );
