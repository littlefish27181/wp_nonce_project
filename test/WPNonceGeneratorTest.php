...
use littlefish27181\WPNonce\WPNonceGenerator;
use PHPUnit\Framework\TestCase;
/**
 * Tests for class Nonce_Generator.
 */
class WPNonceGeneratorTest extends TestCase
{
	/**
	* Test action.
	*
	...
	* @var    object $test_ng The default test generator object.
	...
	protected function setUp() {
 		...
 		$this->test_ng1 = new WPNonceGenerator( $this->test_action );
 		$this->test_ng2 = new WPNonceGenerator( $this->test_action, $this->test_name );
	...
	public function test_instance() {
		$this->assertInstanceOf( WPNonceGenerator::class, $this->test_ng2 );
		$this->assertInstanceOf( WPNonceGenerator::class, $this->test_ng1 );
	}
	/**
 	...
 	*/
 	public function test_default_name() {
 		$ng = new WPNonceGenerator( 'another_action' );
